class Food implements Comparable<Food>{
    ...
    //Implement the compareTo method for comparision
    @Override
    public int compareTo(Food other){
        //If food ratings are same , sort based on their names(lexicographically smaller name food will be on top)
        if(foodRating == other.foodRating){
            return foodName.compareTo(other.foodName);
        }
        //Sort based on food rating 
...
class FoodRatings {
    ...
    //Store all the food of a cuisine in a priority queue
    //Priority queue -> Food : (foodRating , foodName)
    ...
    public void changeRating(String food, int newRating) {
        ...
        //Insert the new food rating , food name elements into the respective cuisine's priority queue
    ...
    public String highestRated(String cuisine) {
        ...
        //If the lastest rating of food doesnot match the rating on which it was sorted int the priority queue,
